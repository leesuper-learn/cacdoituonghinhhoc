...
namespace cacdoituonghinhhoc
{
    internal class Program
    {
        static void Main(string[] args)
        {
                ...
                Console.WriteLine($"ChuVi : {circle.GetPerimeter()}");
                Console.WriteLine();
                Console.WriteLine();
                Console.WriteLine();

                // rectangle
                Rectangle r = new Rectangle(32, 16, "blue", false);
                Console.WriteLine(r.ToString());
                Console.WriteLine($"S : {r.GetArea()}");
                Console.WriteLine($"ChuVi : {r.GetPerimeter()}");
                Console.WriteLine();
                Console.WriteLine();
                Console.WriteLine();

                //Square
                Squaren squaren = new Squaren(10, "yellow", true);
                Console.WriteLine(squaren.ToString());
                Console.WriteLine($"S : {squaren.GetArea()}");
                Console.WriteLine($"ChuVi : {squaren.GetPerimeter()}");
                Console.WriteLine();
                Console.WriteLine();
                Console.WriteLine();
